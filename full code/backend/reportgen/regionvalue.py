...
def createreport(pdlist,market,reportname,value,tablesplit,g):
    ...
    paragraph_format12= doc.styles['Normal'].paragraph_format
...
#     paragraph_format14 = doc.styles['FIG_no_NM'].paragraph_format
    ...
    wb.save(dir+"/files/"+market+" "+reportname+" Value Market Report_Forecast Excel doc Till "+str(g[1])+".xlsx")
    os.remove(pic)  

    return (("/files/"+market+" "+reportname+" Value Market Report_Forecast Till "+str(g[1])+".docx","/files/"+market+" "+reportname+" Value Market Report_Forecast Excel doc Till "+str(g[1])+".xlsx"))
