                ...
                for l3 in l2["toc2_component"]:
                    ...
                    if l3["toc3_component"]!=[]:
                        ...
                        for l4 in l3["toc3_component"]:
                            ...
                            pdlist[country+" "+l4["toc4_name"]+" MARKET BY, "+i["toc_name"]+"#"+str(count2)]={"heading":4,"sin":1,"comp":"Market","data":{l4["toc4_name"]:l4["split"]}}
                        count2+=1
                    else:
                        pdlist[country+" "+l3["toc3_name"]+" MARKET BY, "+i["toc_name"]+"#"+str(count2)]={"heading":3,"sin":1,"comp":"Market","data":{l3["toc3_name"]:l3["split"]}}    
                
            else:
                pdlist[country+" "+l2["toc2_name"]+" MARKET BY, "+i["toc_name"]+"#"+str(count)]={"heading":2,"sin":1,"comp":"Market","data":{l2["toc2_name"]:l2["split"]}}
            count1+=1
        count+=1
    return pdlist
...
def createreport(pdlist,reportname,market,value,tablesplit,g):
    ...
    for k in pdlist:
        ...
        try:
            ...
            doc.add_paragraph(writeup(f,pdlist[k]["comp"],market,value),style="Normal")
        ...
        # doc.add_page_break()
    doc.save(dir+"/files/"+market+" "+reportname+" Value Market Report_Forecast Till "+str(g[1])+".docx")
    wb.save(dir+"/files/"+market+" "+reportname+" Value Market Excel Report_Forecast Till "+str(g[1])+".xlsx")
    os.remove(pic)
    return (("/files/"+market+" "+reportname+" Value Market Report_Forecast Till "+str(g[1])+".docx","/files/"+market+" "+reportname+" Value Market Excel Report_Forecast Till "+str(g[1])+".xlsx"))
